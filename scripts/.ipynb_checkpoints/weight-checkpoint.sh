...
# do
# for WEIGH in 0 1 2 4  
# do
# # for SEED in 1 2 3
# # do
# #     DIR=${FOLDER}_${NCTX}_${L}/base2new/train_base/${DATASET}/${WEIGH}$_shots_${SHOTS}_${WEIGHT}/${TRAINER}/${CFG}/seed${SEED}
# #     if [ -d "$DIR" ]; then
...
# for SEED in 1 2 3
# do
#     COMMON_DIR=${DATASET}/${WEIGH}$_shots_${SHOTS}_${WEIGHT}/${TRAINER}/${CFG}/seed${SEED}
